...
function migrateMeta(src) {
  ...
  delete m.reeds;
  if (m.swift) { m.warp = Math.min(12, (m.warp || 0) + m.swift); } // Стрімкий час → Адаптація часу
  delete m.swift;
