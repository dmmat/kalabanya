...
const ACHIEVEMENTS = [
  ...
  { id: "ocean",    e: "🌊", nm: "Океан",           dq: "Здійснити мрію — дорости до об'єму океану (4М)." },
  { id: "worldocean", e: "🌍", nm: "Світовий океан", dq: "Дорости до об'єму Світового океану (150М).", hidden: true },
